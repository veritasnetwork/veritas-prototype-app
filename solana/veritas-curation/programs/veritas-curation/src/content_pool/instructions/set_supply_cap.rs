...
/// Adjust the transition point between quadratic and linear curve regions
pub fn set_supply_cap(
    ...
    require!(new_supply_cap >= min_cap, ErrorCode::InvalidParameters);
    ...
    msg!("Supply cap updated: new_supply_cap={}", new_supply_cap);
    Ok(())
}
