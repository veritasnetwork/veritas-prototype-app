      ...
      <div className="backdrop-blur-xl bg-white dark:bg-veritas-darker-blue/80 border border-slate-200 dark:border-veritas-eggshell/10 rounded-3xl p-6 md:p-8 shadow-2xl">
        <div className="flex items-center space-x-3 mb-6">
          <div className="p-3 rounded-2xl bg-veritas-primary dark:bg-veritas-eggshell">
            <MessageCircle className="w-6 h-6 text-white dark:text-veritas-primary" />
          </div>
          <div>
        ...
        <div className="text-center py-8">
          <div className="w-16 h-16 rounded-full bg-veritas-primary/10 dark:bg-veritas-eggshell/10 flex items-center justify-center mx-auto mb-4">
            <MessageCircle className="w-8 h-8 text-veritas-primary dark:text-veritas-eggshell" />
          </div>
    ...
    <div className="backdrop-blur-xl bg-white dark:bg-veritas-darker-blue/80 border border-slate-200 dark:border-veritas-eggshell/10 rounded-3xl p-6 md:p-8 shadow-2xl shadow-yellow-500/10">
      ...
      <div className="space-y-4">
        {comments.map((comment) => (
          <div
            key={comment.id}
            className="p-5 bg-slate-50 dark:bg-veritas-darker-blue/60 rounded-2xl hover:bg-slate-100 dark:hover:bg-veritas-eggshell/5 transition-all duration-300"
          >
            {/* Comment header */}
            <div className="flex items-start justify-between mb-3">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 rounded-xl bg-veritas-primary/10 dark:bg-veritas-eggshell/10 flex items-center justify-center">
                  {comment.isExpert ? (
                    <Award className="w-5 h-5 text-veritas-orange" />
                  ) : (
                    <User className="w-5 h-5 text-veritas-primary dark:text-veritas-eggshell" />
                  )}
                </div>
                <div>
                  <div className="flex items-center space-x-2">
                    ...
                    {comment.isExpert && (
                      <span className="px-2 py-1 text-xs font-medium rounded-full bg-veritas-orange/20 text-veritas-orange border border-veritas-orange/30">
                        Expert
                      </span>
                    )}
                  </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <button className="text-sm text-veritas-primary/60 dark:text-veritas-eggshell/60 hover:text-veritas-orange transition-colors">
                Reply
              </button>
            </div>
          </div>
      ...
      {/* Add comment section */}
      <div className="mt-6 p-4 bg-slate-50 dark:bg-veritas-darker-blue/60 rounded-2xl">
        <div className="text-center">
          ...
          <button className="px-6 py-2 bg-veritas-primary dark:bg-veritas-light-blue text-white dark:text-veritas-darker-blue font-medium rounded-xl hover:shadow-lg hover:scale-105 transition-all duration-300">
            Add Comment
          </button>
        </div>
      </div>
