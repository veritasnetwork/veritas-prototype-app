...
import { NewsContent, Content, Belief } from '@/types/content.types';
import { ChartComponent } from '@/components/content-details/components/ChartComponent';
import { Clock, Users } from 'lucide-react';
// import { FeedContext } from '@/contexts/FeedContext'; // Uncomment when needed

interface NewsCardProps {
  content: NewsContent | Content; // Accept both for backward compatibility
...
export const NewsCard: React.FC<NewsCardProps> = ({
  ...
  // const currentAlgorithm = feedContext?.currentAlgorithm || null; // Uncomment when needed for algorithm-specific features
  ...
  const getImageSrc = () => {
    const article = 'article' in content ? content.article : null;
      ...
      >
        <div className="flex h-full">
          ...
          <div className="relative w-1/2 overflow-hidden">
            {('article' in content && content.article.thumbnail) ? (
              <Image 
                src={('article' in content ? content.article.thumbnail : undefined) || ''}
            ...
            <div className="absolute bottom-4 left-4 right-4">
              ...
              {('article' in content && content.article.excerpt) && (
  ...
  return (
    ...
    >
      ...
      {('article' in content && content.article.excerpt && variant !== 'compact') && (
