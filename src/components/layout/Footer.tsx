...
const VeritasFooter = () => {
  ...
  return (
    <footer className="hidden md:block relative bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-800 border-t border-slate-200 dark:border-slate-700">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-[#B9D9EB]/5 via-transparent to-[#0C1D51]/5" />
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center mb-6">
              <div className="relative w-12 h-12">
                <div className="absolute inset-0 bg-gradient-to-br from-[#0C1D51] to-[#B9D9EB] rounded-2xl" />
                <div className="absolute inset-[2px] bg-white dark:bg-slate-900 rounded-[14px] flex items-center justify-center">
                  <span className="text-xl font-black text-transparent bg-clip-text bg-gradient-to-br from-[#0C1D51] to-[#B9D9EB]">
                    V
                  </span>
                </div>
              </div>
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="group p-3 rounded-2xl bg-gradient-to-br from-[#B9D9EB]/10 to-[#0C1D51]/5 hover:from-[#B9D9EB]/20 hover:to-[#0C1D51]/10 transition-all duration-300 hover:scale-110"
                    aria-label={social.label}
                  >
                    <Icon className="w-5 h-5 text-slate-600 dark:text-slate-300 group-hover:text-[#0C1D51] dark:group-hover:text-[#B9D9EB] transition-colors duration-300" />
                  </a>
                );
              })}
            </div>
          ...
          {Object.entries(footerLinks).map(([category, links]) => (
            <div key={category}>
              <h3 className="text-[#0C1D51] dark:text-[#B9D9EB] font-semibold text-lg mb-6 capitalize">
                {category}
              </h3>
              <ul className="space-y-4">
                {links.map((link) => (
                  <li key={link.label}>
                    <a
                      href={link.href}
                      className="group flex items-center text-slate-600 dark:text-slate-300 hover:text-[#0C1D51] dark:hover:text-[#B9D9EB] transition-colors duration-300"
        ...
        <div className="border-t border-slate-200 dark:border-slate-700 pt-12 mb-12">
          <div className="max-w-2xl">
            <h3 className="text-2xl font-bold text-[#0C1D51] dark:text-[#B9D9EB] mb-4">
              Stay Updated
            </h3>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <input
                ...
                className="flex-1 px-6 py-4 rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 placeholder-slate-500 dark:placeholder-slate-400 focus:ring-2 focus:ring-[#B9D9EB] focus:border-transparent transition-all duration-300"
              />
              <button className="px-8 py-4 rounded-2xl bg-gradient-to-r from-[#0C1D51] to-[#B9D9EB] text-white font-semibold hover:shadow-2xl hover:shadow-blue-500/25 transform hover:scale-105 transition-all duration-300 whitespace-nowrap">
                Subscribe
              </button>
            </div>
          </div>
