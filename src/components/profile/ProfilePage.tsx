                      ...
                      {holdings.map((holding) => (
                        <CompactPostCard
                          ...
                          post={{
                            ...
                            poolSqrtPriceLongX96: holding.pool.sqrt_price_long_x96,
                            poolSqrtPriceShortX96: holding.pool.sqrt_price_short_x96,
                            poolVaultBalance: holding.pool.vault_balance,
                            poolF: holding.pool.f,
                            poolBetaNum: holding.pool.beta_num,
                            poolBetaDen: holding.pool.beta_den,
                          }}
                          holdings={{
