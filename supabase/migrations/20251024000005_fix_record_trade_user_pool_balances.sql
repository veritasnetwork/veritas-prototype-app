-- Fix record_trade_atomic to not use non-existent created_at column in user_pool_balances
-- The table only has updated_at which has a default value
...
BEGIN
  ...
  -- 6. Upsert user pool balance (WITHOUT created_at - it doesn't exist!)
