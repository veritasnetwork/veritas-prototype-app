-- Fix belief submission updates to only occur on buy operations
-- Belief submissions should NOT be recorded when users sell tokens
...
CREATE OR REPLACE FUNCTION "public"."record_trade_atomic"(
  ...
  "p_s_long_after" numeric DEFAULT NULL::numeric,
  "p_s_short_after" numeric DEFAULT NULL::numeric,
