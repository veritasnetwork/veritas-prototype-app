-- Fix record_trade_atomic to return success field
-- API route expects { success: true, trade_id, token_balance, belief_lock }
-- But function was only returning { trade_id, token_balance, belief_lock }
